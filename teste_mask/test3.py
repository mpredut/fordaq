...
def safely_expand_mask(image, mask, offset):
    """Expand white regions of the mask horizontally by 'offset' pixels on each side without exceeding the image dimensions."""
...
def process_images(mask_paths, image_paths, shift_value):
    ...
    for extracted_image in image_scandura[1:]:
        ...
        cv2.imwrite(f"combined_image{i}.jpg", final_image)  # Optionally update filename if needed
        i = i + 1
